...
class AVProxy:
    ...
    USER_AGENT = 'Mozilla/5.0 (X11; Linux x86_64; rv:24.0) Gecko/20140429 Firefox/24.0 Iceweasel/24.5.0'
    ...
    def open(self, request, timeout=None, retries=0):
        ...
        if not isinstance(request, urllib2.Request):
            request = urllib2.Request(request, headers={'User-Agent': AVProxy.USER_AGENT})
    ...
    def check_connection(self,
        ...
        Note: Minimum kernel socket timeout is 20 sec
        """
        response = None
